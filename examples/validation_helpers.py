...
def run_validation(domain_config, iterations=None, threshold_ratio=None, custom_display=None):
    """
    ...
    assert hasattr(domain_config, 'VALIDATION_TASK'), "domain_config must have VALIDATION_TASK"
    assert hasattr(domain_config, 'ITEMS_TO_VALIDATE'), "domain_config must have ITEMS_TO_VALIDATE"
    assert hasattr(domain_config, 'VALIDATION_SCHEMA'), "domain_config must have VALIDATION_SCHEMA"
